...
{
    protected: 
        vector<int> GetHeaderValuesDataVector(PingTypes pingType, PeerModes mode, ChunkUniqueID chunkuid, uint16_t sizePeerListOu, uint32_t estimatedStreamRate, uint32_t channelId,
