...
class MessagePingBoot : public MessagePing
{
    ...
    public:
        ...
        MessagePingBoot(PeerModes mode, ChunkUniqueID chunkuid, uint16_t sizePeerListOut, uint16_t sizePeerListOut_FREE, uint32_t estimatedStreamRate, uint32_t channelId);
